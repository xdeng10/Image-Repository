...
<body>
    ...
    <header class="">
        <div class="navbar navbar-default visible-xs">
            ...
            <a href="./index.php" class="navbar-brand">Image Repository</a>
        </div>
        ...
        <nav class="sidebar">
            <div class="navbar-collapse" id="navbar-collapse">
                <div class="site-header hidden-xs">
                    ...
                    <p>Find beautiful and inspiring images for your projects.
                    </p>
                </div>
                <ul class="nav">
                    <li><a href="./index.php" title="">Discover</a></li>
                    <li><a href="./artists.php" title="">Artists</a></li>
                </ul>
